...
public class Main : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		base.initialize(rsc);
		add_sprite_for_color(Color.instance("#0080FF"), get_scene_width(), get_scene_height());
		
		rsc.prepare_image("gc","ouma",0.5* get_scene_width(),0.5* get_scene_height());
		image1 = add_sprite_for_image(SEImage.for_resource("gc"));
		image1.move(0,0);

		rsc.prepare_image("gc2","guiltcrown",0.5* get_scene_width(),0.5* get_scene_height());
		image2 = add_sprite_for_image(SEImage.for_resource("gc2"));
		image2.move(0.5*get_scene_width(),0);

		rsc.prepare_image("gc3","oumashu",0.5* get_scene_width(),0.5* get_scene_height());
		image3 = add_sprite_for_image(SEImage.for_resource("gc3"));
		image3.move(0,0.5*get_scene_height());

		rsc.prepare_image("gc4","voidgenome",0.5* get_scene_width(),0.5* get_scene_height());
